...
.PHONY: rc1-serving-test rc1-serving-hooks rc1-serving-schema rc1-serving-false-evidence rc1-serving-all

rc1-serving-test:
	$(PYTHON) tests/test_chromofold_qualification_adapter.py

rc1-serving-hooks:
	$(PYTHON) tests/test_qualification_hooks.py
...
rc1-serving-all: rc1-serving-test rc1-serving-hooks rc1-serving-schema rc1-serving-false-evidence
